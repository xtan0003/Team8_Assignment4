...
```{r g1,fig.cap="GDP Change from 1990 to 2020",echo=FALSE, message=FALSE}
...
```{r g2,fig.cap="Population Change from 1990 to 2020",echo=FALSE,message=FALSE}
...
```{r g3,fig.cap="Inflation Change from 1990 to 2020",echo=FALSE,include=TRUE,message=FALSE}
g3 <- AUS1 %>%
