...
```{r cor, fig.cap="Correlation Graph",echo=FALSE,fig.height =7, fig.width = 7, fig.align='left'}
...
# Linear model for the unemployment rate 

```{r model,fig.width=5, echo=FALSE}
m <- lm(Unemploy_T ~  GDP_growth + Population + `Inflation, consumer prices (annual %)`, data = AUS1)
d <- coef(summary(m))
