...
\caption{\label{tab:edu-change}Percent change in umemployment with different education level}
\centering
...
\caption{residuals}\label{fig:unnamed-chunk-10}
\end{figure}
\providecommand{\docline}[3]{\noalign{\global\setlength{\arrayrulewidth}{#1}}\arrayrulecolor[HTML]{#2}\cline{#3}}
...
\textcite{GDP}
\textcite{Population}
\textcite{femaleunemployment}
\textcite{maleunemployment}
\textcite{totalunemployment}
\textcite{inflation}
